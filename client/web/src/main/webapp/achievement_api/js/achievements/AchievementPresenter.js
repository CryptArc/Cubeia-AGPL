...
AchievementPresenter.prototype.handleSocketEvent = function(message) {
    if (message.type == "achievement") {
        ...
        if (message.achievement.achieved) {
            this.showAchievementGained(message.achievement);
        } else {
...
AchievementPresenter.prototype.showAchievementGained = function(achievement) {
    var parent = document.body;
    var divId = achievement.name+"_gained";
    var container = this.achievementUiBuilder.builUiComponent(parent, divId, "achievement_gained_container");
...
AchievementPresenter.prototype.showAchievementAsCompleted = function(achievement) {
    ...
    this.achievementUiBuilder.addClass(divs.description, "achievement_description_text_achieved")
    if (divs.progressBar) this.achievementUiBuilder.addClass(divs.progressBar, "achievement_progress_bar_achieved")

    this.achievementUiBuilder.addClass(divs.reward, "achievement_reward_label_achieved")
}
