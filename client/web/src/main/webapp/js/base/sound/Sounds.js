...
Poker.Sounds = {
    ...
    "action-check"               :{id:"CHECK"             ,  delay:0,     soundList:[{file:"knockcheck_1",gain:0.3},{file:"knockcheck_1",gain:0.3}]    },
    ...
    PROGRESSION_LEVEL_UP:        {id: "PROGRESSION_LEVEL_UP",       delay: 0,   soundList: [{file:"level_up_1"     ,gain: 0.3}]},
    PROGRESSION_ACHIEVEMENT:     {id: "PROGRESSION_ACHIEVEMENT",       delay: 0,   soundList: [{file:"achievement_1"     ,gain: 0.3}]}
}