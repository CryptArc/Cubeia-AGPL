...
for(b=0;
b<this.invitees.length;
b++){a.details.invitees.push(this.invitees[b])
}return a
}
};
...
b++){a.details.payload.push(this.payload[b])
}return a
}
};
...
b++){a.details.gamedata.push(this.gamedata[b])
...
b++){a.details.servicedata.push(this.servicedata[b])
}return a
}
};
...
b++){a.details.credentials.push(this.credentials[b])
}return a
}
};
...
b++){a.details.mttdata.push(this.mttdata[b])
}a.details.attributes=[];
for(b=0;
b<this.attributes.length;
b++){a.details.attributes.push(this.attributes[b].getNormalizedObject())
...
for(b=0;
b<this.tournaments.length;
b++){a.details.tournaments.push(this.tournaments[b])
}return a
}
};
...
for(b=0;
b<this.value.length;
b++){a.details.value.push(this.value[b])
}return a
}
};
...
for(b=0;
b<this.data.length;
b++){a.details.data.push(this.data[b])
}return a
}
};
...
this.save=function(){return new FIREBASE.ByteArray()
};
...
for(b=0;
b<this.pids.length;
b++){a.details.pids.push(this.pids[b])
}return a
}
};
...
for(b=0;
b<this.removedParams.length;
b++){a.details.removedParams.push(this.removedParams[b])
}return a
}
};
