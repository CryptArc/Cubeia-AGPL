...
Table.prototype.createTablePot = function(tableDivId) {
    ...
    uiElementHandler.createDivElement(potAreaDivId, potAreaDivId+"_label", "Pot:", "table_pot_label", null);
...
Table.prototype.createTableJoinButton = function(tableDivId) {
    ...
    this.buttons = {
        inpuButtons: {label: "Join Table", posX: 85, posY: 90, height: 55, width: 140, hasValue:false, clickFunction:joinTable},
    };


    var divIds = uiUtils.createActionButton(this.buttons.inpuButtons, tableDivId);
...
Table.prototype.potUpdated = function(amount) {
	var tableEntity = entityHandler.getEntityById(this.entityId);
    document.getElementById(tableEntity.ui.tablePotDivId).innerHTML = currencyFormatted(amount);
