...
public class PokerActivator extends DefaultActivator implements MttAwareActivator, PokerActivatorMBean {
    ...
    private void initParticipants(RNGProvider rngProvider, ActivatorContext context) {	
        ...
        participants.add(new PokerParticipant(2, "ITALIAN/cashgame/REAL_MONEY/2", 2, Timings.DEFAULT, TELESINA, rngProvider, cashGameBackendService));
        participants.add(new PokerParticipant(3, "ITALIAN/cashgame/REAL_MONEY/3", 2, Timings.DEFAULT, TELESINA, rngProvider, cashGameBackendService));
    	...
    	participants.add(new PokerParticipant(5, "ITALIAN/cashgame/REAL_MONEY/5", 2, Timings.DEFAULT, TELESINA, rngProvider, cashGameBackendService));
