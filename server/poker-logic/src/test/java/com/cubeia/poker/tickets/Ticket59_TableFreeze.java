...
public class Ticket59_TableFreeze extends AbstractTexasHandTester {
	...
	public void testBothPlayerActs() {
		...
		assertEquals(10, mockServerAdapter.getActionRequest().getOption(PokerActionType.CALL).getMinAmount());
	...
	public void testBigBlindTimesOut() {
		...
		assertEquals("WaitingToStartState", game.getGameState().toString());
