...
public class TelesinaHandComparatorTest {
	...
	public void testPairs() {
		...
		// kicker decides
		assertTrue(comp.compare(new Hand("AS AC KS 8H 7S"), new Hand("AS AC QS 8H 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC QS 8H 7S"), new Hand("AS AC KS 8H 7S")) < 0);

		// kickers are ranked hearts, diamonds, clubs, spades
		assertTrue(comp.compare(new Hand("AS AC KH QH JS"), new Hand("AS AC KD 8S 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KH QH JS"), new Hand("AS AC KC 8S 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KH QH JS"), new Hand("AS AC KS 8S 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KD QH JS"), new Hand("AS AC KC 8S 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KD QH JS"), new Hand("AS AC KS 8S 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KC QH JS"), new Hand("AS AC KS 8S 7S")) > 0);

		// second kicker used
		assertTrue(comp.compare(new Hand("AS AC KH QH 7S"), new Hand("AS AC KH JH 7S")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KH QH 7S"), new Hand("AS AC KH QS JH")) > 0);
	...
	public void testTwoPairs() {
		...
		assertTrue(comp.compare(new Hand("AS AC 7S 7C JD"), new Hand("8S 8C 7S 7C JD")) > 0);
		assertTrue(comp.compare(new Hand("TS TC 7S 7C JD"), new Hand("8S 8C 7S 7C JD")) > 0);
		
		// second pair decides if first share rank
		assertTrue(comp.compare(new Hand("AS AC KS KC JD"), new Hand("AS AC QS QC JD")) > 0);
		assertTrue(comp.compare(new Hand("AS AC QS QC JD"), new Hand("AS AC 7S 7C JD")) > 0);
		
		// kicker decides if both pairs share rank
		// kicker rank has presidence
		assertTrue(comp.compare(new Hand("AS AC KS KC JD"), new Hand("AS AC KS KC 6D")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KS KC QD"), new Hand("AS AC KS KC 7H")) > 0);
		
		// then kicker suit follows
		assertTrue(comp.compare(new Hand("AS AC KS KC JD"), new Hand("AS AC KS KC JS")) > 0);
		assertTrue(comp.compare(new Hand("AS AC KS KC TC"), new Hand("AS AC KS KC TS")) > 0);
		
		// finally if kicker is equal best suit in high pair decides
		assertTrue(comp.compare(new Hand("AH AD KS KC JD"), new Hand("AS AC KS KC JD")) > 0);
		assertTrue(comp.compare(new Hand("AD AC KS KC JD"), new Hand("AH AS KS KC JD")) < 0);
