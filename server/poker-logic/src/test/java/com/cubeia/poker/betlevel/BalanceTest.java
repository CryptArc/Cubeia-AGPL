...
public class BalanceTest extends AbstractTexasHandTester {
	...
	public void testBetAmounts1() {
		...
		assertEquals(4000, mockServerAdapter.getActionRequest().getOption(PokerActionType.CALL).getMinAmount());
		assertEquals(4000, mockServerAdapter.getActionRequest().getOption(PokerActionType.CALL).getMaxAmount());
		assertEquals(4900, mockServerAdapter.getActionRequest().getOption(PokerActionType.RAISE).getMinAmount());
		assertEquals(4900, mockServerAdapter.getActionRequest().getOption(PokerActionType.RAISE).getMaxAmount());
		...
		assertEquals(100, mockServerAdapter.getActionRequest().getOption(PokerActionType.BET).getMinAmount());
		assertEquals(900, mockServerAdapter.getActionRequest().getOption(PokerActionType.BET).getMaxAmount());
		act(p[1], PokerActionType.BET, 900);
		
		assertTrue(mp[2].isActionPossible(PokerActionType.CALL));
		assertFalse(mp[2].isActionPossible(PokerActionType.RAISE));
		assertEquals(900, mockServerAdapter.getActionRequest().getOption(PokerActionType.CALL).getMinAmount());
		assertEquals(900, mockServerAdapter.getActionRequest().getOption(PokerActionType.CALL).getMaxAmount());
	}
	...
	public void testBetAmounts2() {
		...
		assertTrue(mp[1].isActionPossible(PokerActionType.BET));
		assertEquals(100, mockServerAdapter.getActionRequest().getOption(PokerActionType.BET).getMinAmount());
		assertEquals(5900, mockServerAdapter.getActionRequest().getOption(PokerActionType.BET).getMaxAmount());
		act(p[1], PokerActionType.BET, 4000);
