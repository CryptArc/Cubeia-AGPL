...
public class TelesinaHandStrengthEvaluator {
	...
	public  TelesinaHandStrength getStrength(List<Card> cards, Rank deckLowestRank) {
		TelesinaHandStrength strength = checkStraightFlush(cards, 5, deckLowestRank, true);
		if (strength != null) {
			return strength;
		}
		...
		strength = checkStraight(cards, 5, deckLowestRank, true);
		if (strength != null) {
			return strength;
		}
	...
	public TelesinaHandStrength checkStraight(List<Card> cards) {
		return checkStraight(cards, 1, Rank.TWO, false);
	}
	 ...
	 * @param deckLowestRank The lowest Rank card kept in the deck. Rank.TWO corresponds to a full deck.
	 * @param allowLowAces 
	 * @return
	 */
	public TelesinaHandStrength checkStraight(List<Card> cards, int minimumLength, Rank deckLowestRank, boolean allowLowAces) {
		...
		return checkStraightAcesLow(cards, deckLowestRank);
	}
	...
	public TelesinaHandStrength checkStraightFlush(List<Card> cards) {
		return checkStraightFlush(cards, 1, Rank.TWO, false);
	}
	 ...
	 * @return
	 */
	public TelesinaHandStrength checkStraightFlush(List<Card> cards, int minimumLength, Rank deckLowestRank, boolean allowLowAces) {
		if (checkFlush(cards) == null) {
			return null;
		}
		
		TelesinaHandStrength checkStraight = checkStraight(cards, minimumLength, deckLowestRank, allowLowAces);
	...
	private TelesinaHandStrength checkStraightAcesLow(List<Card> cards, Rank deckLowestRank) {
		// arbitrarily refuse to recognise one card straights
		if (cards.size() < 2) {
			return null;
		}
