...
public class TelesinaHandStrengthEvaluator implements HandTypeEvaluator, Serializable {
	...
	public TelesinaHandStrength getBestHandStrength(List<Card> cards) {
		...
		strength = new TelesinaHandStrength(HandType.HIGH_CARD, Collections.EMPTY_LIST, Collections.EMPTY_LIST, cards, cards);
		return strength;
	}
	...
	public TelesinaHandStrength checkPair(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.ONE_PAIR, setCards, Collections.EMPTY_LIST, cc, cards);
	}
	...
	public TelesinaHandStrength checkTwoPair(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.TWO_PAIRS, highSet, lowSet, cc, cards);
	}
	...
	public TelesinaHandStrength checkFullHouse(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.FULL_HOUSE, threeSet, twoSet, Collections.EMPTY_LIST, cards);
	}
	...
	public TelesinaHandStrength checkThreeOfAKind(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.THREE_OF_A_KIND, threeSet, Collections.EMPTY_LIST, cc, cards);
	}
	...
	public TelesinaHandStrength checkFourOfAKind(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.FOUR_OF_A_KIND, fourSet, Collections.EMPTY_LIST, cc, cards);
	}
	...
	public TelesinaHandStrength checkFlush(List<Card> cards, int minimumLength) {
		...
		return new TelesinaHandStrength(HandType.FLUSH, cards, Collections.EMPTY_LIST, cards, cards);
	}
	...
	public TelesinaHandStrength checkStraightFlush(List<Card> cards, int minimumLength, boolean allowLowAces) {
		...
		return new TelesinaHandStrength(HandType.STRAIGHT_FLUSH, cards, Collections.EMPTY_LIST, cards, cards);
	}
	...
	private TelesinaHandStrength checkStraightAcesHigh(List<Card> cards) {
		...
		return new TelesinaHandStrength(HandType.STRAIGHT, firstKicker, secondKicker, Collections.EMPTY_LIST, cards);
	}
