...
public class HandResult implements Serializable {
	...
	private final Collection<RatedPlayerHand> playerHands;
	...
	public HandResult(Map<PokerPlayer, Result> results, Collection<RatedPlayerHand> playerHands) {
	    this.results = results;
	    this.playerHands = playerHands;
	}
	
	public Collection<RatedPlayerHand> getPlayerHands() {
	    return playerHands;
	}
