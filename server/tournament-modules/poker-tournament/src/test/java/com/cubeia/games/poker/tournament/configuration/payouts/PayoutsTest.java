...
public class PayoutsTest {
    ...
    public void testPlayerNotInTheMoneyGetsZero() {
        assertThat(payouts.getPayoutsForPosition(56), is(BigDecimal.ZERO));
    }

    @Test
    public void testBubbleGetsBubble() {
        assertThat(sitAndGoPayouts.getPayoutList().size(), is(3));
        assertThat(sitAndGoPayouts.getPayoutsForPosition(3), not(BigDecimal.ZERO));
        assertThat(sitAndGoPayouts.getPayoutsForPosition(4), is(BigDecimal.ZERO));
    }

    @Test
    public void testRangedPayouts() {
        // 0.72% of $5000 = 36
        assertThat(payoutsWithRange.getPayoutsForPosition(36), is(new BigDecimal(3600)));
    }
