...
public class RakeSettings implements Serializable {
    ...
    public static final long DEFAULT_RAKE_LIMIT = 500;
    public static final long DEFAULT_RAKE_LIMIT_HEADS_UP = 150;
    ...
    @Column(nullable = false)
    private long rakeLimit2Plus = DEFAULT_RAKE_LIMIT_HEADS_UP;

    @Column(nullable = false)
    private BigDecimal rakeFraction3Plus = DEFAULT_RAKE_FRACTION;

    @Column(nullable = false)
    private long rakeLimit3Plus = DEFAULT_RAKE_LIMIT;
    ...
    public RakeSettings(BigDecimal fraction, long limit, long headsUpLimit) {
    ...
    public long getRakeLimit2Plus() {
        return rakeLimit2Plus;
    }

    public void setRakeLimit2Plus(long rakeLimit2Plus) {
    ...
    public long getRakeLimit3Plus() {
        return rakeLimit3Plus;
    }

    public void setRakeLimit3Plus(long rakeLimit3Plus) {
    ...
    public long getRakeLimit5Plus() {
        return rakeLimit5Plus;
    }

    public void setRakeLimit5Plus(long rakeLimit5Plus) {
    ...
    public void setRakeLimit(int playersCount, Long rakeLimit) {
        switch (playersCount) {
            case 2:
    ...
    public long getRakeLimit(int playersCount) {
        switch (playersCount) {
            case 2:
                return rakeLimit2Plus;
            case 3:
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (rakeLimit2Plus ^ (rakeLimit2Plus >>> 32));
