...
public class BetStrategyFactory {
    ...
    public static BetStrategy createBetStrategy(BetStrategyType type, long minBet) {
        return createBetStrategy(type, minBet, false);
    }

    public static BetStrategy createBetStrategy(BetStrategyType type, long minBet, boolean doubleBetRound) {
