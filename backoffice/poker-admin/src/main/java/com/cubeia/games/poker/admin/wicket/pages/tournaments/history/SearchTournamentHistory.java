...
public class SearchTournamentHistory extends BasePage {
    ...
    private void addForm() {
        ...
        options.set("timeFormat", "'H:i'");

        form.add(new BootstrapDatePicker("fromDate").setRequired(true));
        form.add(new TextField<String>("fromTime"));
        add(new TimePickerBehaviour("#fromTime", options));

        form.add(new BootstrapDatePicker("toDate").setRequired(true));
        add(new TimePickerBehaviour("#toTime", options));
